...
A skill is a SKILL.md file that teaches Claude how to handle a specific type of
task. This guide explains how to write skills that actually work.
...
**This means:** The `description` and `triggers` are the most important parts.
If they're wrong, the skill never loads.
...
name: skill-name
description: >
  What this skill does and when to use it. This is read by Claude to decide
  relevance. Be specific. Include the main use case.
triggers:
...
> "Deep knowledge of Neon Postgres: serverless connection pooling, database
> branching for dev/test/preview environments, Drizzle ORM integration,
> migrations, and Row Level Security patterns. Use whenever Neon is in the
> stack."
