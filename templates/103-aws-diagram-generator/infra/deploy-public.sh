...
#   - ACM certificate for your-app.yourdomain.com in us-east-1
...
# Find ACM cert for your-app.yourdomain.com in us-east-1
CERT_ARN=$(aws acm list-certificates \
  --profile "${PROFILE}" --region us-east-1 \
  --query "CertificateSummaryList[?DomainName=='your-app.yourdomain.com'].CertificateArn" \
  --output text 2>/dev/null)

if [[ -z "$CERT_ARN" || "$CERT_ARN" == "None" ]]; then
  echo "  No ACM cert found for your-app.yourdomain.com in us-east-1."
  echo "  Creating certificate request..."
  CERT_ARN=$(aws acm request-certificate \
    --domain-name "your-app.yourdomain.com" \
