...
Phase 1: Market and Feasibility   - PULSE -> SCHEMA
...
def create_tasks(game_idea: str, agents: dict | None = None) -> list[Task]:
    ...
    # --- Phase 1: Market and Feasibility ----------------------------
    ...
    compliance_review = Task(
        ...
        1. Privacy and Data Collection - does the game collect PII? GDPR/COPPA implications.
