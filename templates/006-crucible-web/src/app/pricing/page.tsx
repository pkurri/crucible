                  ...
                  <ul className='space-y-4'>
                    {tier.features.map((feature: string, fIdx: number) => (
                      <li key={fIdx} className='flex items-start'>
                        <CheckCircle2
                          className={`h-5 w-5 shrink-0 mr-3 ${isPopular ? 'text-fuchsia-400' : 'text-neutral-500'}`}
                        />
        ...
        <div className='mt-32 border border-neutral-800 bg-neutral-900/30 backdrop-blur-xl rounded-3xl p-10 flex flex-col md:flex-row items-center justify-between gap-10 relative overflow-hidden'>
          ...
          <div className='relative z-10 md:w-2/3'>
            <h4 className='text-2xl font-bold text-white mb-4'>
              Crucible Enterprise Cloud
            </h4>
            <p className='text-neutral-400 text-lg max-w-2xl'>
              Tired of managing local infrastructure? Let us host your Genkit
              orchestrators and advanced AI swarms with our 99.99% uptime
              guarantee.
            </p>
          </div>
          <div className='relative z-10 md:w-1/3 flex justify-end w-full'>
            <a
              href='mailto:sales@crucible.dev?subject=Enterprise%20Cloud%20Demo%20Request'
              className='px-8 py-4 bg-white text-neutral-950 hover:bg-neutral-200 font-bold rounded-xl transition-colors flex items-center whitespace-nowrap w-full sm:w-auto justify-center'
            >
