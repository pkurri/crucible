...
If the repo has ECC2 state enabled, prefer adding or reading checkpoints through this project control pane or state-store-backed scripts instead of scattering untracked notes.
