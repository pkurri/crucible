...
description: API Gateway setup with Kong or AWS API Gateway for routing, rate limiting, authentication, and request/response transformation. Use when building API gateways, managing microservice routing, implementing rate limiting, or setting up API authentication.
triggers:
  - "API gateway"
  - "Kong"
  - "rate limiting"
...
Build API gateways with routing, rate limiting, authentication, and transformation.
