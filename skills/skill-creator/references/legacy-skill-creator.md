...
- **Multi-step processes**: See [workflows.md](workflows.md) for sequential
  workflows and conditional logic
- **Specific output formats or quality standards**: See
  [output-patterns.md](output-patterns.md) for template and example patterns
...
Optional frontmatter fields are allowed when needed: `license`, `compatibility`,
`metadata`, and `allowed-tools` (experimental). Prefer keeping frontmatter
minimal.
