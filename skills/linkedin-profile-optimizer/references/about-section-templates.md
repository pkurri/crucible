...
- **Voice:** first person ("I help...") never third person ("Jane is a
  passionate...")

The hook is everything — most readers never click "see more", so the first 265
chars have to carry the whole pitch.
...
- First 265 chars ("Why do most B2B founders burn 40% of their pipeline on
  bad-fit leads? I help 1-10M ARR SaaS founders rebuild their inbound motion
  around signal, not volume.") earns the "see more" click
...
- Third-person corporate speak — "Jane is a seasoned professional with over 15
  years..."
