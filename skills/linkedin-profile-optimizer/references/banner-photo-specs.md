...
- Keep text/CTA in the **right 2/3** of the image — the profile photo covers the
  left 1/3 on desktop and overlaps even more on mobile

### Banner composition checklist

- High contrast background (pure white, pure black, single brand color — not
  noisy photos)
...
- **Neutral background** (solid color, uncluttered wall) — no distracting
  backgrounds
...
- Banner + photo = first visual impression; visitors decide whether to scroll in
  under 2 seconds
- Profile with a real, current photo: **14x more profile views** than one
  without
- High-quality banner: **+23% profile view duration** (correlation, from
  Co.Actor's 2026 data)
- Banner space is essentially free advertising — 90% of users waste it on a
  default or stock image
