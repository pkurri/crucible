...
Not: `"Responsible for X"` or `"Managed X"` — these are resume fossils that
LinkedIn's NLP ignores.
...
Led, Built, Increased, Delivered, Shipped, Cut, Drove, Launched, Grew, Closed,
Retained, Rebuilt, Scaled

### Action verbs (weak — avoid)

Worked on, Handled, Assisted with, Responsible for, Participated in, Helped
with, Was part of
...
- Don't list generic soft skills without evidence ("Leadership", "Teamwork") —
  back them with roles that prove it
- If you have conflicting skills across roles (e.g., front-end dev + sales),
  keep them — LinkedIn tolerates breadth
...
- Authority profiles with 10+ recent recommendations: **4x trust signal** vs.
  profiles with 0
