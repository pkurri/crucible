...
description:
  ...
  function size, duplication, over-engineering, and magic number issues with
...
All suggestions target **implementation approach** only—never suggest changing
the code's functionality, output, or behavior.
...
> [!TIP] Project conventions should refer to `CLAUDE.md`, `AGENTS.md`, or
> project-defined coding standards.
...
- Output: `clean-code-review.json` (structured issue list for
...
- Complete cases for each dimension (naming, functions, DRY, YAGNI, magic
  numbers)
