...
- Security and permissions: input validation, authentication/authorization,
  injection risks, sensitive info in logs
...
[Security, data loss, functionality bugs, issues that would cause production
incidents]

#### Important (Should Fix)

[Architecture issues, missing error handling, test gaps, requirements
misalignment, etc.]
