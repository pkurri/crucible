...
> **Output:**
>
> - **Formula:** F10 Contrarian + Historical Receipts (confidence 0.72).
>   Secondary: F5 Self-Proving Meta (0.28).
> - **Hook (first 210 chars):** "Every B2B software company is (or should be)
>   building an agentic version of their product."
> - **Body:** single bold claim → 3 paragraphs of reasoning → specific list of
>   product changes required
> - **Close:** implicit call to action ("Seen this play out in your market
>   yet?")
> - **Blank template:**
>
>   ```text
