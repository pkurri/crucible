...
- the user wants to know what was ported from another agent system and what still needs to be rebuilt inside crucible
...
The value is in collapsing noisy automation into one canonical crucible lane, not in preserving every historical path.
