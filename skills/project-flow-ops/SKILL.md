...
| Port/Rebuild | useful idea, but should be manually re-landed inside crucible |
...
- External-source features should be rebuilt inside crucible when they are valuable but not self-contained
...
- "Map GitHub issues into program lanes"
