...
description: Application monitoring and observability with metrics, logs, traces, and alerting. Use when setting up monitoring, configuring observability, implementing distributed tracing, or setting up alerts.
triggers:
  - "monitoring"
  - "observability"
  - "metrics"
