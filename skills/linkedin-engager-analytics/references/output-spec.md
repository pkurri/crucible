...
Canonical sample outputs for the engager-analytics report. See `SKILL.md` for
the workflow steps.
...
> Input: analyze engagers on
> <https://www.linkedin.com/posts/author-handle_activity-id>, max 100
>
> Output:
>
