...
MCP enables automatic execution of billing operations. This is optional — you
can always use CLI or Dashboard instead.
...
This connects to Stripe's official MCP server at `https://mcp.stripe.com` and
...
- **Live mode**: Requires user to explicitly say "live mode" + double
  confirmation
...
and Dashboard alternatives. All operations in [SKILL.md](SKILL.md) can be
performed manually.
