...
Prefer dry-run plans and local queue files before enabling recurring or event-driven actions. Keep credentials, private workspace exports, personal datasets, and account-specific automations out of reusable crucible artifacts.
...
| Hermes Component | crucible Equivalent | How |
|------------------|---------------|-----|
...
| Context Manager | Session management + memory | crucible 2.0 session lifecycle |
