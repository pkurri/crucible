...
Use this skill when a repo needs a project-specific crucible surface instead of the default full install.

The goal is not to guess what "feels useful." The goal is to classify crucible components with evidence from the actual codebase.

## When to Use

- A project only needs a subset of this project and full installs are too noisy
