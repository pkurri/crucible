...
Cross-request caching (LRU/memory) can help hot endpoints, but it can also serve
stale data or leak memory. Only do it when you have clear TTL/invalidation.
