...
This is the **single entry point** for crucible reviews. It includes an internal auto-triage:
...
If triage selects React/Next performance review and a crucible `run_dir` is available, also persist:
- `run_dir/evidence/react-best-practices-review.md`

If triage selects UI guidelines audit and a crucible `run_dir` is available, also persist:
