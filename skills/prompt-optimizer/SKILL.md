...
description: >-
  Analyze raw prompts, identify intent and gaps, match available components
...
Analyze a draft prompt, critique it, match it to crucible ecosystem components,
...
- User says "how should I use crucible for..."
...
- User is asking about crucible configuration (use `configure-ecc` instead)
...
Map intent + scope + tech stack (from Phase 0) to specific crucible components.
...
A compact version for experienced crucible users. Vary by intent type:
...
- "Optimize this prompt for this project"
...
|-----------|------------------|
| `configure-ecc` | User hasn't set up crucible yet |
