...
5. If site copy matters, include the current project landing page and framing.
...
If the user wants project voice and live sources are thin, start here unless newer source material overrides it:
