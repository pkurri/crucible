...
description:
  AI-powered code review automation. Analyzes pull requests for bugs, security
  issues, performance problems, and style violations. Use when reviewing code,
  analyzing PRs, or conducting automated code quality checks.
triggers:
  - 'review code'
  - 'analyze PR'
  - 'code review'
...
Automated code review powered by AI. Analyzes code for bugs, security
