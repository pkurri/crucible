...
The script audits the current working directory by default and auto-detects whether the target is a skills repo or a consumer project.
...
6. Suggested skills to apply next.
