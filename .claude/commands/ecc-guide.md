---
description: Navigate the current agents, skills, commands, hooks, and docs from the live repository.
---

# /ecc-guide

Use this command as a conversational map of the skills and agents in this project. It should help the user discover the right crucible surface for their task without dumping the entire README or stale catalog counts.
...
- `scripts/ci/catalog.js --json` for live catalog counts
...
- `/project-init` for stack-aware onboarding of a target project
